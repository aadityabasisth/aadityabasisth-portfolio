        ...
        <BlurFade delay={BLUR_FADE_DELAY * 4}>
          <div className="prose max-w-full text-pretty font-sans text-sm text-muted-foreground dark:prose-invert">
            {Array.isArray(DATA.summary)
              ? DATA.summary.map((line, idx) => <p key={idx}>{line}</p>)
              : DATA.summary}
          </div>
        </BlurFade>
      </section>
      ...
      <section id="connect-linkedin">
        <div className="flex flex-col items-center w-full pt-1 pb-0 gap-1">
          ...
          <div className="flex items-center gap-2 text-muted-foreground text-xl">
            ...
            <Link
              href="https://www.linkedin.com/in/aadityabasisth/"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-primary transition-colors"
            >
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#0077B5]">
